...
| ------- | -------- | ---------- |
| `verbump` | `VerBump` | [**VerBump**](https://github.com/jv-k/VerBump) — a release tool for Git projects: SemVer bump, CHANGELOG, tag, push |
...
- **Auto-bump** ([`bump-formula.yml`](.github/workflows/bump-formula.yml))
  checks [jv-k/VerBump](https://github.com/jv-k/VerBump) every 6 hours (and
...
[main repo](https://github.com/jv-k/VerBump/issues); packaging problems on
